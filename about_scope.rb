...
class AboutScope < EdgeCase::Koan
  ...
  def test_dog_is_not_available_in_the_current_scope
	...
	# Ruby scoping operator for clases nested in modules
  ...
  # ------------------------------------------------------------------
	...
	# Note that this class has been instantiated
  class String
  end

	# Class names without a scope specifier assume the current scope
  ...
  def test_nested_string_is_not_the_same_as_the_system_string
	...
	# ::class forces global scope for the class
  ...
  def test_you_can_get_a_list_of_constants_for_any_class_or_module
		# Getting a list of constants for the module includes alls the class
		# names
    assert_equal [:Dog], Jims.constants 
    assert Object.constants.size > 0 # Object has all the classes that inherit
																		 # from it as constants that it contains.
  end
end
