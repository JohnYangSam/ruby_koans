...
class AboutMethods < EdgeCase::Koan
  ...
  # Using * for multiple arguments placed in to a method
  ...
  # Declares the following method private
  private :my_private_method

  # Obviously okay to call the private methods within the class
  # and without a reciever
  def test_calling_private_methods_without_receiver
    assert_equal "a secret", my_private_method
  end

  # CANNOT call a private method with a RECIEVER
